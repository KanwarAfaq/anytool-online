...
export const tools = [
  ...
  ['percentage','Percentage Calculator','general','Calculate percentage change and percentage of an amount.'],
  ['loan-payment','Loan Payment Calculator','general','Calculate monthly loan payments, total repayment and total interest.'],
  ['random-picker','Random Name & Number Wheel','general','Add names or numbers, edit the list and spin a colorful wheel to pick one at random.'],
  ['timer','Timer & Alarm','general','Run a countdown timer with quick presets, pause/reset controls and selectable alarm sounds.'],
  ['image-resize','Resize Image','image','Resize JPG, PNG or WebP in your browser while keeping aspect ratio when you want.'],
  ['image-compress','Compress Image','image','Compress an image locally with adjustable format and quality.'],
  ['png-to-jpg','PNG to JPG','image','Convert PNG to JPEG locally in your browser.'],
  ['jpg-to-png','JPG to PNG','image','Convert JPEG to PNG locally in your browser.'],
  ['dpi-calculator','DPI Calculator','image','Convert pixels and print dimensions to DPI.'],
  ['qr-generator','QR Code Generator','image','Generate a downloadable QR code locally.'],
  ['qr-scanner','QR Code Scanner','image','Read a QR code from an uploaded image locally.'],
  ...
  ['image-to-sketch','Image to Hand-drawn Sketch','image','Turn a photo into a pencil, ink or soft graphite sketch locally in your browser.'],
  ...
  ['taiwan-elder-care','Taiwan Elderly Care Subsidy & Bed Finder','money','Check Taiwan\'s 2026 residential-care subsidy, selected local placement subsidies, and official facility capacity or vacancy sources by city.'],
  ['ocr','AI OCR','ai','Extract text from an image or PDF using the configured AI gateway.'],
