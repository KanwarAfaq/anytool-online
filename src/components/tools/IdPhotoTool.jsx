  ...
  return <div className="space-y-5">
    <div className="card p-5">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <label><span className="mb-1.5 block text-sm text-slate-400">{L.width}</span><input className="input" type="number" value={width} onFocus={e=>e.target.select()} onChange={e=>setWidth(Number(e.target.value)||1)}/></label>
        <label><span className="mb-1.5 block text-sm text-slate-400">{L.height}</span><input className="input" type="number" value={height} onFocus={e=>e.target.select()} onChange={e=>setHeight(Number(e.target.value)||1)}/></label>
