 ...
 return <>
  ...
  <section id="tools" className="mx-auto max-w-7xl px-4 py-10">
   <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
    ...
    <label className="relative block w-full lg:max-w-sm"><span className="sr-only">{C.find}</span><Search className="absolute start-4 top-3.5 text-slate-500" size={16}/><input aria-label={C.find} className="input home-tool-search ps-12" value={query} onChange={e=>setQuery(e.target.value)} placeholder={C.find}/></label>
   </div>
