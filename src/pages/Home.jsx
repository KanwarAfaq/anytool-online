 ...
 return <>
  ...
  <section className="mx-auto max-w-7xl px-4 pb-8 pt-16 md:pt-24">
   <div className="max-w-4xl">
    ...
    <div className="mt-8 flex flex-wrap gap-3"><a href="#tools" className="btn-primary">{t('browse')} <ArrowRight className="ms-2" size={17}/></a><Link to="/tools/take-home-pay" className="btn-ghost">{t('trySalary')}</Link></div>
   </div>
